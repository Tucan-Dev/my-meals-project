...
function MealProvider({ children }: PostProviderProps){
           ...
           // let verification = false
            ...
            mealSegunda.map((itemMeal, index) => {
                    ...
                    if(itemMeal.meal.meal === item.selectedCategoryMeal){
                        ...
                        AsyncStorage.setItem(CHAVE_STORAGE_MEAL_SEGUNDA, JSON.stringify(alter));
                       // verification = true;
                    }
            })
        ...
        if(item.selectedDayWeek === 'Quarta-feira'){
            ...
            mealTerca.map((itemMeal, index) => {
                    ...
                    if(itemMeal.meal.meal === item.selectedCategoryMeal){
                        alter[index] = data;
                        setMealQuarta(alter);
                        AsyncStorage.setItem(CHAVE_STORAGE_MEAL_QUARTA, JSON.stringify(alter));
                        //verification = true;
                    }
            })
        ...
        if(item.selectedDayWeek === 'Quinta-feira'){
            ...
            mealTerca.map((itemMeal, index) => {
                    ...
                    if(itemMeal.meal.meal === item.selectedCategoryMeal){
                        alter[index] = data;
                        setMealQuinta(alter);
                        AsyncStorage.setItem(CHAVE_STORAGE_MEAL_QUINTA, JSON.stringify(alter));
                       // verification = true;
                    }
            })
        ...
        if(item.selectedDayWeek === 'Sábado'){
            ...
            mealTerca.map((itemMeal, index) => {
                    ...
                    if(itemMeal.meal.meal === item.selectedCategoryMeal){
                        alter[index] = data;
                        setMealSabado(alter);
                        AsyncStorage.setItem(CHAVE_STORAGE_MEAL_SABADO, JSON.stringify(alter));
                        // verification = true;
                    }
            })
        ...
        if(item.selectedDayWeek === 'Domingo'){
            ...
            mealTerca.map((itemMeal, index) => {
                    ...
                    if(itemMeal.meal.meal === item.selectedCategoryMeal){
                        ...
                        AsyncStorage.setItem(CHAVE_STORAGE_MEAL_DOMINGO, JSON.stringify(alter));
                        // verification = true;
                    }
            })
    ...
    async function loadStorageMeals(){
        const storageSegunda = await AsyncStorage.getItem(CHAVE_STORAGE_MEAL_SEGUNDA);
        ...
        const storageDomingo = await AsyncStorage.getItem(CHAVE_STORAGE_MEAL_DOMINGO);
