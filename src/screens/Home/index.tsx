...
import { Header, ButtonAbout, Meals, DayWeekSelected, HeaderPages} from "../../components";
...
export function Home(){
    ...
    }, [mealDomingo, mealSegunda, mealTerca, mealQuarta, mealQuinta, mealSexta, mealSabado]);
    ...
    return(
        <SP.Container>
            ...
            <SP.Main>
                <SP.ContainerListDaysWeek>
                    <SP.ListDaysWeek
                        ...
                        renderItem={({ item }) => 
                            <DayWeekSelected data={item} onPress={() => handleSelectDay(item)}/>
                        }
                    />
                </SP.ContainerListDaysWeek>
            ...
            <Modal visible={isVisibleModalView}
                transparent
            >
